import { ChatCircle, Gauge, Ticket, Gear, Brain, Pulse, Rocket, HardDrives } from '@phosphor-icons/react';

export type GlobalView = 'dashboard' | 'activity' | 'missions' | 'tickets' | 'braindump' | 'assistant' | 'services';
